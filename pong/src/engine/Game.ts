...
/*   Updated: 2025/05/11 11:15:05 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export class PongGame {
	...
	async init(): Promise<void> {
		...
		this.populateWorlds();
		this.currentWorld = this.worldPool.oceanWorld;
	...
	populateWorlds() {
		this.worldPool = {
			...
			ruinWorld: createWorld('ruins', 'Ruins of Yonder', WORLD_COLORS.city),
			oceanWorld: createWorld('ocean', 'Pelagic Netherscape', WORLD_COLORS.void),
		};
	}
