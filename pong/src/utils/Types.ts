...
/*   Updated: 2025/05/11 11:38:06 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export interface DepthLineBehavior {
    ...
    amplitudeVariation?: number;   // Add this property
    minBottomHeight?: number | null;  // Add this property
}
...
export interface WaveDepthLineOptions extends DepthLineOptions {
	amplitude?: number;
    frequency?: number; 
    waveOffset?: number;
    phaseShift?: number;
