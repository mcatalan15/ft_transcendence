...
/*   Updated: 2025/04/24 17:35:43 by hmunoz-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export class UI extends Entity {
	...
	private setUpScore(width: number, height: number): TextData {
		return {
			tag: 'score',
			text: '0 - 0',
			x: 0,
	...
	private setUpTimer(width: number, height: number): TextData {
		return {
			tag: 'timer',
			text: '00:00:00',
			x: 0,
