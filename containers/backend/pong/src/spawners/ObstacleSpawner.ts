...
export class ObstacleSpawner {
  private static buildObstacle(
    ...
    for (let i = 0; i < depth; i++) {
      ...
      let obstacle = ObstacleFactory.createObstacle(worldSystem.game, obstacleBehavior, figureType, uniqueId);
  ...
  static buildPachinko(worldSystem: WorldSystem, depth: number): void {
      this.buildObstacle(worldSystem, depth, 'pachinko');
  }
