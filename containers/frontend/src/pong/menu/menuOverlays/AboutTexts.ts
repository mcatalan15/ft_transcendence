...
/*   Updated: 2025/06/17 17:45:20 by hmunoz-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export class AboutTexts extends Entity {
    ...
    private getColumnDataFR() {
        return [
            ...
            {
                tag: 'projectContent',
                text: "Cette humble recréation de Pong a été développée dans le cadre du projet ft_transcendence à 42 Barcelone. Elle a été réalisée en respectant les exigences obligatoires, sur lesquelles plusieurs modules optionnels ont été ajoutés. Le jeu peut être joué aussi bien en mode classique — un hommage au jeu original d’Atari conçu par Nolan Bushnell et sorti en 1972 — qu’en mode étendu, qui propose de nombreuses fonctionnalités supplémentaires. Celles-ci incluent notammen:\n\n" +
