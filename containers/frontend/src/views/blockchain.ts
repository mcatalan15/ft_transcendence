        ...
        <div class="mb-4">
            ...
            <div class="flex items-center space-x-4 mb-2">
                <div class="w-1/2">
                    ...
                    <input type="number" id="player1Id" class="w-full p-2 rounded bg-gray-700 text-white">
                </div>
                <div class="w-1/2">
                    <label for="player1IsAi" class="block text-white mb-1">Player 1 is AI</label>
                    <input type="checkbox" id="player1IsAi" class="w-full p-2 rounded bg-gray-700 text-white">
                </div>
            </div>
        </div>
        <div class="mb-4">
            ...
            <div class="flex items-center space-x-4 mb-2">
                <div class="w-1/2">
                    ...
                    <input type="number" id="player2Id" class="w-full p-2 rounded bg-gray-700 text-white">
                </div>
                <div class="w-1/2">
                    <label for="player2IsAi" class="block text-white mb-1">Player 2 is AI</label>
                    <input type="checkbox" id="player2IsAi" class="w-full p-2 rounded bg-gray-700 text-white">
                </div>
            </div>
        </div>
        <div class="mb-4">
            <div class="flex items-center space-x-4 mb-2">
                <div class="w-1/2">
                    ...
                    <input type="text" id="gameMode" class="w-full p-2 rounded bg-gray-700 text-white">
                </div>
                <div class="w-1/2">
